...
Webflow.require("ix2").init({
  events: {
    e: {
      ...
      target: {
        id: "65066453b1e3fcb7f0004cdc|7cbbef55-9204-f06c-91c2-c2ea22c00981",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-7": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "65066453b1e3fcb7f0004cdd|00e39c3d-e8e6-3444-3811-a602badbb4eb",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  selector: ".wrapper",
                  selectorGuids: ["d8cd06e7-b352-4d56-2113-ff2662828968"],
                },
                value: 1,
                unit: "",
              },
